...
const ProjectItem = ({title, backgroundImg, tech, projectUrl, data,id})=>{
	return(
		<Link
      		...
      		key={id}
    	>
    		<a className="text-white flex flex-col cursor-pointer shadow-md hover:shadow-xl shadow-inherit overflow-hidden hover:scale-95 transition-transform duration-300 border shadow-2xl">
